            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tr>
                            <th scope="col"
                                class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Libellé
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                                Copropriété
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Date de
                                Début
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Date de
                                Fin
                            ...
                            <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                    <div class="flex items-center justify-end space-x-4">
                                        @can('viewAny', App\Models\BudgetPoste::class)
                                            {{-- Adaptez la permission si besoin --}}
                                            <a href="{{ route('exercices.budget.index', $exercice) }}"
                                               class="text-blue-600 hover:text-blue-900">Budget</a>
                                        @endcan
                                        @can('create', App\Models\AppelDeFonds::class)
                                            {{-- Adaptez la permission si besoin --}}
                                            <a href="{{ route('exercices.appels.create', $exercice) }}"
                                               class="text-green-600 hover:text-green-900">Générer Appels</a>
                                        @endcan
                                        @can('update', $exercice)
                                        ...
                                        @endcan
                                        @can('delete', $exercice)
                                            <form action="{{ route('exercices.destroy', $exercice) }}" method="POST"
