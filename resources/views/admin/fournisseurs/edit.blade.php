                            ...
                            <div>
                                ...
                                <div class="mt-6 grid grid-cols-1 gap-y-8 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="compte_comptable" id="compte_comptable" value="{{ old('compte_comptable', $fournisseur->compte_comptable) }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300" placeholder="Ex: 401002">
                                        </div>
