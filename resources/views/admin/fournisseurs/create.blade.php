                            ...
                            <div>
                                ...
                                <div class="mt-6 grid grid-cols-1 gap-y-8 sm:grid-cols-2">
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="nom" id="nom" value="{{ old('nom') }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300" placeholder="Ex: EDF, Veolia, ...">
                                        </div>
