<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Modifier le Syndic :') }} {{ $syndic->nom_entreprise }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900">
                    <form action="{{ route('syndics.update', $syndic) }}" method="POST">
                        @csrf <!-- Protection de sécurité -->
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input type="text"
                                           name="nom_entreprise"
                                           id="nom_entreprise"
                                           value="{{ old('nom_entreprise', $syndic->nom_entreprise) }}"
