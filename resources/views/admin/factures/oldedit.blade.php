                            ...
                            <div class="space-y-8">
                                <div>
                                    ...
                                    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                        ...
                                        <div class="sm:col-span-3"><label for="date_emission">{{ __('Date d\'émission') }}</label><input type="date" name="date_emission" id="date_emission" value="{{ old('date_emission', $facture->date_emission) }}" required class="mt-2 block w-full ring-1"></div>
                                        <div class="sm:col-span-3"><label for="date_echeance">{{ __('Date d\'échéance') }}</label><input type="date" name="date_echeance" id="date_echeance" value="{{ old('date_echeance', $facture->date_echeance) }}" class="mt-2 block w-full ring-1"></div>
                                    </div>
                                </div>
                            </div>
